...
module.exports = function(opts, cb, projectRoot) {
    ...
    var defaults = {
        ...
        minify: false,
        server: {
            baseDir: [cordovaFiles.www.ios, cordovaFiles.www.android],
            routes: {}
        },
        watchOptions: {},
        files: []
    ...
    defaults.server.routes[cordovaFiles.www.android] = path.join(projectRoot, cordovaFiles.www.android);
    defaults.server.routes[cordovaFiles.www.ios] = path.join(projectRoot, cordovaFiles.www.ios);
